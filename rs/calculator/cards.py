...
class Card(CardInterface):
    def __init__(self, card_id: CardId, upgrade: int, cost: int, needs_target: bool, card_type: CardType,
                 ethereal: bool = False, exhausts: bool = False, retains: bool = False, autoplay: bool = False):
        ...
        self.autoplay: bool = autoplay  # can be ignored, is set by end_turn_hook if relevant
