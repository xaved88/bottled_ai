...
from config import presentation_mode, p_delay, p_delay_s, slow_events
...
class EventHandler(Handler):
    ...
    def find_event_choice(self, state: GameState) -> str:
        ...
        if event_name == "Ominous Forge":
            return "choose 0"  # This is too pain full...
        ...
        if event_name == "Council of Ghosts":
            return "choose 1"  # Being a ghost is closer to die than not :(
